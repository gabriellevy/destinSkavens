...
Lieu::Lieu(TypeLieu typeLieu):m_TypeLieu(typeLieu)
{
    ...
    case TypeLieu::Malefosse: {
        m_Nom = "Malefosse";
        m_Description = "";
        m_PoidsProba = new Condition(0.2, p_Relative);
    } break;
    ...
    case TypeLieu::Fosse_Bilieuse: {
        ...
        m_PoidsProba = new Condition(0.05, p_Relative);
    } break;
    ...
    case TypeLieu::Sous_la_Lustrie: {
        ...
        m_Description = "";
        m_PoidsProba = new Condition(0.3, p_Relative);
    } break;
    ...
    case TypeLieu::Sous_estalie: {
        ...
        m_Description = "";
        m_PoidsProba = new Condition(0.08, p_Relative);
    } break;
