...
Profession::Profession(TypeProfession typeProfession)
{
    ...
    case TypeProfession::Cultivateur_de_champignons : {
        ...
        m_Description = "";
        m_Conditions.push_back(new Condition(0.25));
    }break;
    case TypeProfession::Batisseur_de_taudis : {
        m_StatutSocial = 0;
        m_Nom = "Bâtisseur de taudis";
        m_Description = "";
        m_Conditions.push_back(new Condition(0.15));
    }break;
    ...
    case TypeProfession::Gardien_de_nourissons : {
        ...
        m_Description = "";
        m_Conditions.push_back(new Condition(0.005));
    }break;
    case TypeProfession::Recolteur_de_nourriture_des_marais : {
        m_StatutSocial = 0;
        m_Nom = "Récolteur de nourriture des marais";
        m_Description = "";
        m_Conditions.push_back(new Condition(0.1));
    }break;
    case TypeProfession::Docker : {
        m_StatutSocial = 0;
       m_Nom = "Docker";
       m_Description = "";
       m_Conditions.push_back(new Condition(0.02));
    }break;
    ...
    case TypeProfession::Garde_d_esclave : {
       ...
       m_Description = "";
       m_Conditions.push_back(new Condition(0.008));
    }break;
    ...
    case TypeProfession::Espion_chez_les_autres_clans_skavens : {
       ...
       m_Description = "";
       m_Conditions.push_back(new Condition(0.0005));
    }break;
    ...
    case TypeProfession::Ingenieur : {
       ...
       m_Nom = "Ingénieur";
       m_Description = "";
       // !!!!!!!!!!!!!!! à continuer ici et surtout en faisant des conditions plus complètes, pas juste un chiffre
    }break;
